// ROS 2 hardware interface was likely sending a value that you converted directly to PWM (e.g., 0 to 255). 
// While that works for basic testing, it is "open-loop," meaning the robot has no way to guarantee it is actually moving at the speed ROS requested.
